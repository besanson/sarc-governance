...
- CH2 (single-pass unsoundness is real). In S4, single-pass and two-phase verdicts differ on at least one decision, in the predicted direction. Result: 1212 divergences; directions {"single_pass_admits_then_violates": 0, "single_pass_holds_remediated_compliant": 0}
- CH3 (deterministic selectivity). False-hold rate on clean, authorised, in-budget decisions is exactly zero. Result: 0
- CH4 (coverage honesty). plausible_outlier detection is zero at every gate and in composition; covered-class detection equals the union of member coverages. Result: {}

Table 1. Decisions, per-gate veto counts, winner-gate distribution, by scenario. | Scenario | Decisions | Admitted | Held | DQ Vetoes | SARC Vetoes | Green Vetoes |
|----------|-----------|----------|------|-----------|-------------|-------------|
...
Table 2. Cross-gate matrix: injected class by winner gate. | Defect Class | DQ | SARC | Green | Union |
|---|---|---|---|---|
| cross_source_contradiction | 116 | 7 | 0 | 2 |
| lineage_missing | 101 | 7 | 0 | 2 |
| missing_mandatory_field | 105 | 0 | 0 | 1 |
| plausible_outlier | 116 | 4 | 0 | 2 |
| schema_drift | 126 | 0 | 0 | 1 |
| stale_master_data | 119 | 9 | 0 | 2 |
| superseded_golden_record | 109 | 4 | 0 | 2 |

Table 3. Two-phase versus single-pass divergences in S4, with pre and post order values and the cap. | Decision | Two-Phase | Single-Pass | V_pre | V_post | Cap Kappa |
|----------|-----------|-------------|-------|--------|-----------|
| 0 | BLOCK | ADMIT | 0.00 | 0.00 | 0.00 |
| 3 | ADMIT | BLOCK | 0.00 | 0.00 | 0.00 |
| 14 | BLOCK | ADMIT | 0.00 | 0.00 | 0.00 |
| 17 | ADMIT | BLOCK | 0.00 | 0.00 | 0.00 |
| 24 | BLOCK | ADMIT | 0.00 | 0.00 | 0.00 |
| 27 | ADMIT | BLOCK | 0.00 | 0.00 | 0.00 |
| 28 | ADMIT | BLOCK | 0.00 | 0.00 | 0.00 |
| 34 | BLOCK | ADMIT | 0.00 | 0.00 | 0.00 |
| 40 | ADMIT | BLOCK | 0.00 | 0.00 | 0.00 |
| 88 | BLOCK | ADMIT | 0.00 | 0.00 | 0.00 |

Table 4. Loss versus clean counterfactual, executed versus held split. | Scenario | Executed | Held | Loss (vs Clean) |
|----------|----------|------|------------------|
| S1 | 10184 | 616 | 0.0% |
| S2 | 10152 | 648 | 0.0% |
| S3 | 10165 | 635 | 0.0% |
